...
class TopSnackbarController {
  ...
  private static final int VERY_LONG_DURATION_MS = LONG_DURATION_MS * 3;
  ...
  private static class Holder {
    static final TopSnackbarController INSTANCE = new TopSnackbarController();
  }

  public static TopSnackbarController getInstance() {
  ...
  private void scheduleTimeoutLocked(SnackbarRecord r) {
    ...
    } else if (r.duration == TopSnackbar.LENGTH_VERY_LONG) {
